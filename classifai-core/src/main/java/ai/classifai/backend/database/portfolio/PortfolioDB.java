 ...
 */
package ai.classifai.backend.database.portfolio;

import ai.classifai.backend.action.ActionOps;
import ai.classifai.backend.action.FileGenerator;
import ai.classifai.backend.action.FileMover;
import ai.classifai.backend.action.ProjectExport;
import ai.classifai.backend.action.parser.PortfolioParser;
import ai.classifai.backend.action.rename.RenameDataErrorCode;
...
import ai.classifai.backend.database.annotation.AnnotationQuery;
import ai.classifai.backend.database.versioning.Annotation;
import ai.classifai.backend.database.versioning.ProjectVersion;
...
import ai.classifai.core.entities.properties.ProjectMetaProperties;
    ...
    public Future<Void> exportProject(String projectId, int exportType) {
        ...
        runQuery(PortfolioDbQuery.getExportProject(), params)
                .onComplete(DBUtils.handleResponse(
                        ...
                        cause -> {
                            projectExport.setExportStatus(ProjectExportStatus.EXPORT_FAIL);
