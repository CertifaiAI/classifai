...
public class SegDbQuery extends AnnotationQuery
{
    ...
    private static final String CREATE_PROJECT = "CREATE TABLE IF NOT EXISTS Project (uuid UUID, project_id UUID, img_path VARCHAR(2000), polygons CLOB, img_depth INT, " +
