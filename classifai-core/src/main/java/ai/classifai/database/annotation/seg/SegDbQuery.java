...
public class SegDbQuery extends AnnotationQuery
{
    ...
    private final static String CREATE_PROJECT = "CREATE TABLE IF NOT EXISTS Project (uuid integer, project_id integer, img_path varchar(2000), polygons varchar(65535), img_depth integer, " +
