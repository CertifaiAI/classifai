...
public class SegDbQuery extends AnnotationQuery
{
    ...
    private final static String CREATE_PROJECT = "CREATE TABLE IF NOT EXISTS Project (uuid INT, project_id INT, img_path VARCHAR(2000), polygons CLOB, img_depth INT, " +
