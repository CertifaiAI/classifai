...
public class BoundingBoxDbQuery
{
    ...
    public final static String RETRIEVE_DATA = "select img_path, bnd_box, img_depth, image_x, image_y, image_w, image_h, image_ori_w, image_ori_h from Project where uuid = ? and project_id = ?";

    public final static String RETRIEVE_DATA_PATH = "select img_path from Project where uuid = ? and project_id = ?";

    public final static String UPDATE_DATA = "update Project set bnd_box = ?, image_x = ?, image_y = ?, image_w = ?, image_h = ?, image_ori_w = ?, image_ori_h = ? where uuid = ? and project_id = ?";
