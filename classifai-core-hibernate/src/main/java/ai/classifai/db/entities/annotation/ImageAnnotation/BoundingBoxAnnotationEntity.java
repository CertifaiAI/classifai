...
public class BoundingBoxAnnotationEntity extends ImageAnnotationEntity
{
    ...
    public BoundingBoxAnnotationEntity(long annotationId, DataVersionEntity dataVersionEntity, int position, String color, String label, int lineWidth, float x1, float x2,
                                       float y1, float y2, float dist2ImgX, float dist2ImgY)
    {
        super(annotationId, dataVersionEntity, position, color, label, lineWidth);
    ...
    public static BoundingBoxAnnotationEntity getAnnotationFromJson(JsonObject jsonObject, DataVersionEntity dataVersionEntity, int position)
    {
        ...
        return new BoundingBoxAnnotationEntity(id, dataVersionEntity, position, color, label, lineWidth, x1, x2, y1, y2, dist2ImgX, dist2ImgY);
    }
}
